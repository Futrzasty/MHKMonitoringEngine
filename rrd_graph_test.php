...
$ipsec4h = array( "--end", "now", "--start=end-4h", "--width=690", "--height=124", "--full-size-mode", "--border=0", "--color=BACK#444444", "--color=CANVAS#444444", "--color=FONT#cccccc", "--color=ARROW#222222", "--imgformat=PNG",
...
$optst4h = array( "--end", "now", "--start=end-4h", "--width=690", "--height=124", "--full-size-mode", "--border=0", "--color=BACK#444444", "--color=CANVAS#444444", "--color=FONT#cccccc", "--color=ARROW#222222",
...
$optst12h = array( "--end", "now", "--start=end-12h", "--width=690", "--height=124", "--full-size-mode", "--border=0", "--color=BACK#444444", "--color=CANVAS#444444", "--color=FONT#cccccc", "--color=ARROW#222222",
                "DEF:temp=/var/www/rrd-data/jag_ups.rrd:temp:AVERAGE",
                "DEF:humi=/var/www/rrd-data/jag_ups.rrd:humi:AVERAGE",
                "LINE1:temp#ff0000:Temperatura (°C) ",
                "VDEF:tempcur=temp,LAST",
...
$optsl4h = array( "--end", "now", "--start=end-4h", "--width=1500", "--height=124",
		"DEF:temp=/var/www/rrd-data/jag_ups.rrd:temp:AVERAGE",
		"DEF:humi=/var/www/rrd-data/jag_ups.rrd:humi:AVERAGE",
...
$optsl24h = array( "--end", "now", "--start=end-24h", "--width=1500", "--height=124",
		"DEF:temp=/var/www/rrd-data/jag_ups.rrd:temp:AVERAGE",
		"DEF:humi=/var/www/rrd-data/jag_ups.rrd:humi:AVERAGE",
		"LINE1:temp#00ff00:Temperatura (°C) ",
		"VDEF:tempcur=temp,LAST",
...
$optsl30d = array( "--end", "now", "--start=end-30d", "--width=1500", "--height=124",
		"DEF:temp=/var/www/rrd-data/jag_ups.rrd:temp:AVERAGE",
		"DEF:humi=/var/www/rrd-data/jag_ups.rrd:humi:AVERAGE",
		"LINE1:temp#00ff00:Temperatura (°C) ",
		"VDEF:tempcur=temp,LAST",
...
$optsl365d = array( "--end", "now", "--start=end-365d", "--width=1500", "--height=124",
		"DEF:temp=/var/www/rrd-data/jag_ups.rrd:temp:AVERAGE",
		"DEF:humi=/var/www/rrd-data/jag_ups.rrd:humi:AVERAGE",
		"LINE1:temp#00ff00:Temperatura (°C) ",
		"VDEF:tempcur=temp,LAST",
