<?php
$refresh = 20;
if ($_SERVER["REMOTE_ADDR"] != '192.168.90.143') $refresh = 20;
?>
<!DOCTYPE html
...
<?php
	...
	$nas_qnap1_free1 = snmp2_get("192.168.0.52", "public", ".1.3.6.1.4.1.24681.1.2.17.1.5.1");
	$nas_2d_free1 = snmp2_get("192.168.0.56", "public", ".1.3.6.1.4.1.24681.1.2.17.1.5.1");
	...
	echo '<div style="float: left;">fri spejs:';
	//if ($sj_ups_temp < $th_temp_lo) $color = $cl_othr_bu;
	//else if ($sj_ups_temp < $th_temp_hi) $color = $cl_othr_gr;
	//else $color = $cl_othr_re;
	echo '<div class="ramka" style="background-color:'.$color.';"><b>'.$nas_qnap1_free1.'</b></div>';
        echo '</div>';

	echo '<div style="float: left;">fri spejs 2d:';
	//if ($sj_ups_temp < $th_temp_lo) $color = $cl_othr_bu;
	//else if ($sj_ups_temp < $th_temp_hi) $color = $cl_othr_gr;
	//else $color = $cl_othr_re;
	echo '<div class="ramka" style="background-color:'.$color.';"><b>'.$nas_2d_free1.'</b></div>';
        echo '</div>';
